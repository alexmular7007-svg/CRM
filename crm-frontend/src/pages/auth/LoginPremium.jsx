...
import { Mail, Lock, ArrowRight, LayoutDashboard, MessageSquare, Users, Sparkles, Activity } from 'lucide-react'
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16 relative">
        <div className="w-full max-w-md">
          <motion.div 
            ...
            className="mb-10"
          >
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 mb-3">Welcome back</h2>
            <p className="text-gray-600 text-lg">Sign in to your TaskFlow workspace</p>
          </motion.div>
          ...
          >
            ...
            <div className="text-xs text-blue-800 space-y-1">
              ...
              <p className="text-blue-700 mt-2">Or use: test2@example.com, admin@example.com</p>
            </div>
          </motion.div>
